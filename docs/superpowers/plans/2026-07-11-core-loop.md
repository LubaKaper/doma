...
- [x] **Step 2: Create the venv and install**
...
- [x] **Step 5: Add projection tests for scans, novelty, saturation**
...
- [x] **Step 1: Create the smoke corpus fixture**
...
- [x] **Step 3: Run tests to verify current status**
...
- [x] **Step 2: Run it against the smoke corpus**
